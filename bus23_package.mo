package bus23_package "System automatically translated from PSSE CIM using XSLT_OpenIPSL."
  model bus23
    ...
    bus23_package.Generators.GEN101_1_957a gen101_1_957a(P_0 = 7.5E8, Q_0 = 8.1193E7, V_b = 21600, v_0 = 1.020000000, angle_0 = 0.2887906608);
    bus23_package.Generators.GEN102_1_9584 gen102_1_9584(P_0 = 7.5E8, Q_0 = 8.1193E7, V_b = 21600, v_0 = 1.020000000, angle_0 = 0.2887906608);
    bus23_package.Generators.GEN206_1_958d gen206_1_958d(P_0 = 8.0E8, Q_0 = 6.0E8, V_b = 18000, v_0 = 1.023620000, angle_0 = -0.0518344897);
    bus23_package.Generators.GEN211_1_9597 gen211_1_9597(P_0 = 6.0E8, Q_0 = 1.7747E7, V_b = 20000, v_0 = 1.040420000, angle_0 = 0.2255015849);
    bus23_package.Generators.GEN3011_1_95a2 gen3011_1_95a2(P_0 = 2.58656E8, Q_0 = 1.04041E8, V_b = 13800, v_0 = 1.040000000, angle_0 = 0.000000000);
    bus23_package.Generators.GEN3018_1_95ac gen3018_1_95ac(P_0 = 1.0E8, Q_0 = 8.0E7, V_b = 13800, v_0 = 1.021770000, angle_0 = -0.0712163546);
    // -- Fault Event
  ...
  equation
    ...
    // -- Connect fault event:
    connect(Fault.p, EAST500_9441.p);
  end bus23;
