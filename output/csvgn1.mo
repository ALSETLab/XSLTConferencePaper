...
OpenIPSL.Electrical.Buses.Bus SHUNT(V_b = 100000 ,v_0 = 1.000000000 ,angle_0 = 0.000000000);

// -- Lines:
OpenIPSL.Electrical.Branches.PwLine L1_2_1(R=0.001000000, X=0.2000000000,G=0.0000000000, B =0.0000000000);
OpenIPSL.Electrical.Branches.PwLine L2_4_1(R=0.000500000, X=0.1000000000,G=0.0000000000, B =0.0000000000);
OpenIPSL.Electrical.Branches.PwLine L4_3_1(R=0.000500000, X=0.1000000000,G=0.0000000000, B =0.0000000000);
...
smib_csvgn1_package.Generators.GEN1_1 gen1_1 (P_0 = 4.0E7,Q_0 = 1.0E7,V_b = 100000,v_0 = 1.000000000,angle_0 = 0.000000000);
smib_csvgn1_package.Generators.GEN3_1 gen3_1 (P_0 = 1.2E7,Q_0 = 1.0E6,V_b = 100000,v_0 = 1.000000000,angle_0 = 0.000000000);
smib_csvgn1_package.Generators.GEN4_1 gen4_1 (P_0 = -0,Q_0 = 1.0E7,V_b = 100000,v_0 = 1.000000000,angle_0 = 0.000000000);
...
connect(SHUNT.p, gen4_1 .p);
connect(GEN01.p, L1_2_1.p);
connect(LOAD.p, L1_2_1.n);
connect(LOAD.p, L2_4_1.p);
connect(SHUNT.p, L2_4_1.n);
connect(SHUNT.p, L4_3_1.p);
connect(GEN02.p, L4_3_1.n);
...
OpenIPSL.Interfaces.PwPin p annotation(Placement(transformation(extent = {{100, -10}, {120, 10}})));
// Writing machine;
GENERATING UNIT THAT IS NOT IN SYSTEM!
end GEN4_1;
end Generators;
